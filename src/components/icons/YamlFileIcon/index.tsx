...
function YamlFileIcon({className = 'shrink-0'}) {
  return (
    <svg
      fill="none"
      height="26"
    ...
    >
      ...
      <path d="m14 1 7 7h-5c-1.1046 0-2-.89543-2-2z" fill="#fff" opacity=".5" />
      <path
      ...
      />
      <g fill="#000">
        <path d="m8.05469 14.8635v5.1673h1.10866v-3.5643l1.16025 2.3957h.8727l1.1999-2.4799v3.6474h1.0636v-5.1662h-1.4522l-1.2885 2.3369-1.22722-2.3369z" />
        <path d="m17.9994 18.9079h-2.7272v-4.0456h-1.1296v5.1451h3.8568z" />
      </g>
    </svg>
  )
}

export default YamlFileIcon
